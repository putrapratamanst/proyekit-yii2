              ...
              <?php foreach ($modelsNilai as $i => $modelNilai): ?>
                  <div class="item panel panel-default"><!-- widgetBody -->
                      ...
                      <div class="panel-body">
                           ...
                           <div class="row">
                            <div class="col-sm-6">
                            <?= $form->field ($modelNilai,"[{$i}]id_dhs")->dropDownList(ArrayHelper::map(Dhs::find()->all(),'id','idMatakuliah.matakuliah'),
      ['prompt'=>'Pilih Matakuliah']) ?>
      </div>

      <div class="col-sm-1">
                       <?= $form->field($modelNilai, "[{$i}]nilai")->dropDownList(['A'=>'A','B'=>'B','C'=>'C','D'=>'D','E'=>'E',]) ?>
                                  </div>
